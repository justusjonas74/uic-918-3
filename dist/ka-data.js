...
class EfmProduktePool {
    constructor(produkte) {
        this.produkte = produkte;
    }
    getProductsByOrgID(orgId) {
        const produkteListe = this.produkte[orgId];
        return produkteListe;
    }
    getProduct(orgId, produktnummer) {
        let orgIdResult;
        let produktResult;
...
exports.organisationen = new OrganisationenPool(organisationenListe);
exports.efmProdukteData = {
    6262: {
