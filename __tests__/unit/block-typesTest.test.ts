  ...
  describe('Special Types', () => {
    describe('EFS_DATA', () => {
      ...
      beforeAll(async () => {
        ...
        res = (await fn!(testBuf)) as IEFS_DATA;
        res2 = (await fn!(doubleTestBuf)) as IEFS_DATA;
        resDc10 = (await fn!(testBufDc10)) as IEFS_DATA;
        // done();
      });
    ...
    describe('auftraegeSblocks_V3', () => {
      ...
      let result: interpretFieldResult;
      beforeAll(async () => {
        result = (await fn!(TEST_DATA)) as interpretFieldResult;
      });
      test('should return an object', () => {
